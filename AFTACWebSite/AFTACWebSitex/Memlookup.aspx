...
<body>
    ...
    <div class="pageWrapper regBorder showShadow">
        ...
        <aside class="floatLeft width25 topMargin2em leftMargin5em">
            ...
            <asp:ListBox ID="lstMems" style="margin-top:-.5em;padding:5px;" Width="95%" CssClass="maroonBorder smallShadow" BackColor="Moccasin" Font-Bold="true" ForeColor="#990000" Rows="10" runat="server" OnSelectedIndexChanged="lstMems_SelectedIndexChanged" AutoPostBack="True"></asp:ListBox>
            ...
            <asp:Button ID="btnSearch" CssClass="myBut" runat="server" Text=" Search " OnClick="btnSearch_Click" />   
        </aside>
        ...
        <section class="floatLeft leftMargin2em bottomMarginHalfem topMargin1em width50 maroonBorder smallShadow">
            ...
            <asp:Panel ID="pnlHyper" Visible="false" runat="server">
                <asp:Label ID="Label4" runat="server" ForeColor="Maroon" CssClass="block" Font-Bold="true" Font-Size="1.5em" Text="Click the link below to send EMail to our Membership Chairman to get more information on "></asp:Label>
