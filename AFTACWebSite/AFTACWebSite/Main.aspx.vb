...
Public Class _Default
    ...
    Private Sub _Default_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        ElseIf action = "ddObitsClicked" Then
            ...
            obituary = ds.Tables(0).Rows(0).Item(1) & ""
            name = ds.Tables(0).Rows(0).Item(2)
        ...
        ElseIf action = "butObitSearchClicked" Then
            ...
            sql = "select ID, Case when Archived <> 1 Then rtrim(Name) else rtrim(Name) + ' *' end as Name from Obits Where Name Like '" & Name & "%' order by Name"
            ...
            sql = "Select ID, Obituary from obits where ID = " & ddObitNames.SelectedValue & " and Archived = 1"
            ds = New DataSet
            Get_Dataset(sql, ds)
