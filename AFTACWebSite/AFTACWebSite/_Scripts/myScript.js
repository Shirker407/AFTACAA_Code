...
$(document).ready(function () {
    ...
    $('#myEastGate').click(function () {
        $('.myArts').removeClass('block').addClass('noDisplay');
        $('#EastGateArt').removeClass('noDisplay').addClass('block');
        $([document.documentElement, document.body]).animate({
            scrollTop: $("#EastGatePara").offset().top
        }, 500);
    });
    ...
    $('#myFun').click(function () {
        ...
        window.open('https://www.youtube.com/watch?v=Vrvp-nf2_zI', '');
    //    $('.myArts').removeClass('block').addClass('noDisplay');
    ...
    $('#myAngelo').click(function () {
        OpenObit('Angelo');
    });

    $('#myLand').click(function () {
        OpenObit('Land');
    });
    ...
    $('.obitH1').click(function () {
        ...
        switch (myText) {
            case 'AngeloH2':
                if ($('#AngeloPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#AngeloPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#AngeloH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#AngeloPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#AngeloH2").offset().top
                    }, 500);
                }
                break;
            case 'LandH2':
                if ($('#LandPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#LandPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#LandH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#LandPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#LandH2").offset().top
                    }, 500);
                }
