...
<%--                    <div class="topMargin1em">
                        <asp:ImageButton ID="imgShowDeceasedNo" AlternateText="Checked.jpg" CssClass="floatLeft" Visible="false" Width="2em" runat="server" ImageUrl="~/_Images/nocheck.jpg" OnClick="imgShowDeceasedNo_Click" />
                        <asp:ImageButton ID="imgShowDeceasedYes" AlternateText="noCheck.jpg" CssClass="floatLeft" Visible="true" Width="2em" runat="server" ImageUrl="~/_Images/checked.jpg" OnClick="imgShowDeceasedYes_Click" />
                        <asp:Label ID="Label13" CssClass="floatLeft leftMarginHalfem" Width="8em" Style="margin-top:.3em;" Font-Size="1.3em" ForeColor="Maroon" Font-Bold="true" runat="server" Text="Hide Deceased"></asp:Label>
                        <div class="clear"></div>
                    </div>--%>
...
<%--                    <asp:Label ID="lblUpdate" CssClass="floatLeft topMargin1em leftMargin2em" Visible="false" runat="server" Font-Bold="true" Text="Updating Complete"></asp:Label>--%>
                ...
                `       </div>
                    ...
                    <asp:Label ID="lblReason" CssClass="autoMarginLeftRight" Font-Size="2em" Font-Bold="true" Visible="False" ForeColor="Red" runat="server" Text="A reason must be entered"></asp:Label>
